...
*** DONE cbuild_proc_wait_code fixes (proper sygnal handling), handle errors
...
*** TODO Export __cbuild_int_log and __cbuild_log_vlog
*** TODO Allow rewinding and rewind point for cbuild_temp_*
* Thinking place
...
Waits for dexygen replacement. I want to be able to properly document this, and I can make wikimk do this.
