...
*** TODO make da, sb, stack work like new map (void* + elem_size)

API can provide get (checked and unchecked), set (checked and unchecked), append, append arr, append many
