...
* Partial support
* Some support
  - x86-64 Windows with Cygwin. This platform is derived from x86-64 Linux. As compiler you should use either gcc or clang. As far as I know no other compilers support all extensions this lib requires. ~This platform is tested on CI.~ NOTE: It is too often broken on CI because I does not have hardware to test it on and it has too many quircs with build itself. SO CI is disabled for now.
