 ...
 */
#ifndef CBUILD_GCCMT_TOOLCHAIN
#define CBUILD_GCCMT_TOOLCHAIN
// Project files
...
// Code
namespace CBuild {
template <CBuild::HashImpl hash = CBuild::CBuildHashV2> class GCCMT : public CBuild::Toolchain {
  public:
    /**
     * @brief Construct a new GCCMT object
     *
     * @param id Id
     */
    GCCMT(std::string id) {
