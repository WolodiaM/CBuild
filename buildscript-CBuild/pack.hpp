  ...
  public:
    ...
    void call(std::vector<std::string> args) {
        ...
        CBuild::fs::create({this->work_folder + "/libcbuild/usr/share/doc"},
                           CBuild::fs::DIR);
        CBuild::system("chmod 0755 " + this->work_folder +
                       "/libcbuild/usr/share/doc");
        CBuild::fs::create(
            {this->work_folder + "/libcbuild/usr/share/doc/libcbuild"},
            CBuild::fs::DIR);
        CBuild::system("chmod 0755 " + this->work_folder +
                       "/libcbuild/usr/share/doc/libcbuild");
        ...
        CBuild::system("ln -s " + std::string("libCBuild.so ") +
        ...
        CBuild::system("chmod 0755 " + this->work_folder +
                       "/libcbuild/usr/include/CBuild/task/");
        CBuild::system("chmod 0755 " + this->work_folder +
                       "/libcbuild/usr/include/CBuild/generator/");
        CBuild::system("chmod 0755 " + this->work_folder +
                       "/libcbuild/usr/share/lintian");
        CBuild::system("chmod 0755 " + this->work_folder +
