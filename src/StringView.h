...
/// Delimiter function. Used as comparator in [`cbuild_sv_chop_by_func`](#ID_cbuild_sv_chop_by_func)
/// and [`cbuild_sv_chop_right_by_func`](#ID_cbuild_sv_chop_right_by_func)
///
...
/// [`cbuild_sv_chop_by_func_utf8`](#ID_cbuild_sv_chop_by_func_utf8)
///
...
/// Convert string view to c-string. Allocate memory via [`cbuild_temp_malloc`](Temp.html#ID_cbuild_temp_malloc).
