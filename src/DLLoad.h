...
/// * [pl:eager] By default symbols are loaded lazily (during calls to [`cbuild_dlib_get_sym`](#cbuild_dlib_get_sym). This makes them load eagerly. Can be user to run global constructors.
///
