...
CBUILDDEF void* __cbuild_allocator_arena_realloc(cbuild_allocator_t* self, void* ptr, size_t size) {
	return cbuild_arena_realloc(self->state, ptr, size);
}
CBUILDDEF void __cbuild_allocator_arena_free(cbuild_allocator_t* self, void* ptr) {
	CBUILD_UNUSED(self);
	CBUILD_UNUSED(ptr);
}
CBUILDDEF void* __cbuild_allocator_libc_malloc(cbuild_allocator_t* self, size_t size) {
	CBUILD_UNUSED(self);
	return malloc(size);
}
CBUILDDEF void* __cbuild_allocator_libc_realloc(cbuild_allocator_t* self, void* ptr, size_t size) {
	CBUILD_UNUSED(self);
	return realloc(ptr, size);
}
CBUILDDEF void __cbuild_allocator_libc_free(cbuild_allocator_t* self, void* ptr) {
	CBUILD_UNUSED(self);
	free(ptr);
}
