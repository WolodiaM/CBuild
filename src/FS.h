...
/// Rename file. Alias to [`cbuild_file_move`](symbols.html#ID_cbuild_file_move).
///
/// Uses optimal method for moving file, but in worst case falls back
/// to `cbuild_file_copy(src, dst); cbuild_file_remove(src)`{.c}.
///
...
/// Rename a directory. Alias to [`cbuild_dir_move`](symbols.html#ID_cbuild_dir_move).
///
/// Uses optimal method for moving directory, but in worst case falls back
/// to `cbuild_dir_copy(src, dst); cbuild_dir_remove(src)`{.c}.
///
...
/// Result for [`cbuild_dir_walk_func_t`](symbols.html#ID_cbuild_dir_walk_func_t).
///
...
/// Arguments for [`cbuild_dir_walk_func_t`](symbols.html#ID_cbuild_dir_walk_func_t).
///
/// This structure can be divided into multiple sections:
///
/// * Current entry:
///   - [fl:path] Path to the file system object object (relative and including directory passed to [`cbuild_dir_walk`](symbols.html#ID_cbuild_dir_walk).
...
/// Optional arguments for [`cbuild_path_ext`](symbols.html#ID_cbuild_path_ext).
///
...
///
/// [r:] String allocated via [`cbuild_temp_malloc`](symbols.html#ID_cbuild_temp_malloc).
