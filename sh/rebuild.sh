...
# CBuild_rebuild help will print help message
# Vars
C_PATH=""
SCRIPTS_DIR=""
PLUGIN_INC=""
...
if [ "$1" == "help" ]; then
    echo "Rebuild CBuild user scripts"
    echo "\$1 - user scripts dir"
    echo "\$2 - custom user build args args in format \"-arg1 -arg2\""
    echo "\$3 - custom user link args in format \"-arg1 -arg2\""
    echo "\$4 - custom name of user executable"
    echo "Error codes"
    echo "1 - Too litle number of elements"
    echo "2 - Too many arguments"
    echo "3 - Too litle number of function arguments"
    echo "CBuild_rebuild help will print help message"
    exit 0;
fi
C_PATH=$1
...
# Compile
link="-lstdc++ -lCBuild -Wl,-z,origin -Wl,-rpath,\$ORIGIN/CBuild/CBuild ${PLUGIN_INC} ${LINK_ARG}"
