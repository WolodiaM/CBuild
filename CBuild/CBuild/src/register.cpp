...
class Version : public CBuild::Task {
  public:
    ...
    void call(std::vector<std::string> __attribute_maybe_unused__) {
        ...
        CBuild::print(std::string("Compiled on ") + CBUILD_COMPILATION_DATE + std::string(" at ") +
...
void CBuild::Registry::init() {
    ...
    // Generator list task
    Registry::RegisterKeyword("--generator-list", &CBuild::Registry::generatorlist);
...
void CBuild::Registry::RegisterTask(CBuild::Task* task) {
    ...
    try {
        ...
        CBuild::print_full("Error: trying to register task with the same id: " + task->self_name(),
                           CBuild::RED);
        return;
    }
...
void CBuild::Registry::RegisterKeyword(std::string key, CBuild::Task* func) {
    ...
    try {
        ...
        CBuild::print_full("Error: trying to register simmilar keyword: " + key, CBuild::RED);
    }
}
...
void CBuild::Registry::RegisterGenerator(CBuild::generator_base* gen, std::string id) {
    try {
        ...
        CBuild::print_full("Error: trying to register generator with simmilar id: " + id, RED);
    }
}
